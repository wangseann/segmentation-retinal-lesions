...
def get_unet(patch_height, patch_width, channels, n_classes):
    ...
    conv1 = BatchNormalization(scale=True, axis=axis)(conv1)
    ...
    conv2 = BatchNormalization(scale=True, axis=axis)(conv2)
    ...
    conv3 = BatchNormalization(scale=True, axis=axis)(conv3)
    ...
    conv4 = BatchNormalization(scale=True, axis=axis)(conv4)
    ...
    conv5 = BatchNormalization(scale=True, axis=axis)(conv5)
    ...
    conv6 = BatchNormalization(scale=True, axis=axis)(conv6)
    ...
    conv7 = BatchNormalization(scale=True, axis=axis)(conv7)
    ...
    conv8 = BatchNormalization(scale=True, axis=axis)(conv8)
    ...
    conv9 = BatchNormalization(scale=True, axis=axis)(conv9)
